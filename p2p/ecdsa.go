...
func init() {
	pb.KeyType_name[int32(3)] = "ECDSA"
	pb.KeyType_value["ECDSA"] = int32(3)
}
...
func GenerateECDSAKeyPair(src io.Reader) (libp2pcrypto.PrivKey, libp2pcrypto.PubKey, error) {
...
func GenerateECDSAKeyPairWithCurve(curve elliptic.Curve, src io.Reader) (libp2pcrypto.PrivKey, libp2pcrypto.PubKey, error) {
...
func ECDSAKeyPairFromKey(priv *ecdsa.PrivateKey) (libp2pcrypto.PrivKey, libp2pcrypto.PubKey, error) {
	if priv == nil {
...
func UnmarshalECDSAPrivateKey(data []byte) (libp2pcrypto.PrivKey, error) {
...
func UnmarshalECDSAPublicKey(data []byte) (libp2pcrypto.PubKey, error) {
...
func (ePriv *ECDSAPrivateKey) Bytes() ([]byte, error) {
	return libp2pcrypto.MarshalPrivateKey(ePriv)
}

// Type returns the key type
func (ePriv *ECDSAPrivateKey) Type() pb.KeyType {
	return pb.KeyType(32)
}
...
func (ePriv *ECDSAPrivateKey) Equals(o libp2pcrypto.Key) bool {
...
func (ePriv *ECDSAPrivateKey) GetPublic() libp2pcrypto.PubKey {
