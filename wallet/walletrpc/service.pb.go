...
type ImportChainRequest struct {
	Creds                *Credentials           `protobuf:"bytes,1,opt,name=creds,proto3" json:"creds,omitempty"`
	KeyAddr              string                 `protobuf:"bytes,2,opt,name=key_addr,json=keyAddr,proto3" json:"key_addr,omitempty"`
	ChainTree            *SerializableChainTree `protobuf:"bytes,3,opt,name=chain_tree,json=chainTree,proto3" json:"chain_tree,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *ImportChainRequest) GetChainTree() *SerializableChainTree {
	if m != nil {
		return m.ChainTree
	}
	return nil
...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	,
}
