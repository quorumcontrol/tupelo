...
func (z *ChainTreeSubscriptionRequest) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z *ChainTreeSubscriptionRequest) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "ObjectID"
...
func (z *ChainTreeSubscriptionRequest) MarshalMsg(b []byte) (o []byte, err error) {
...
func (z *ChainTreeSubscriptionRequest) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z *ChainTreeSubscriptionRequest) Msgsize() (s int) {
...
func (z *ProvideMessage) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "SpanContext":
			z.SpanContext, err = dc.ReadBytes(z.SpanContext)
			if err != nil {
				return
			}
		default:
...
func (z *ProvideMessage) EncodeMsg(en *msgp.Writer) (err error) {
	...
	// write "SpanContext"
	err = en.Append(0xab, 0x53, 0x70, 0x61, 0x6e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74)
	if err != nil {
		return
	}
	err = en.WriteBytes(z.SpanContext)
	if err != nil {
		return
	}
	return
...
func (z *ProvideMessage) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// string "SpanContext"
	o = append(o, 0xab, 0x53, 0x70, 0x61, 0x6e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74)
	o = msgp.AppendBytes(o, z.SpanContext)
	return
}
...
func (z *ProvideMessage) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "SpanContext":
			z.SpanContext, bts, err = msgp.ReadBytesBytes(bts, z.SpanContext)
			if err != nil {
				return
			}
		default:
...
func (z *ProvideMessage) Msgsize() (s int) {
	s = 1 + 4 + msgp.BytesPrefixSize + len(z.Key) + 6 + msgp.BytesPrefixSize + len(z.Value) + 5 + msgp.BoolSize + 5 + msgp.StringPrefixSize + len(z.From) + 12 + msgp.BytesPrefixSize + len(z.SpanContext)
	return
}
