...
func (Transaction_TransactionType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorConsensus, []int{6, 0}
}
...
func (Authorization_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorConsensus, []int{18, 0}
}
...
func (*SignatureResponse) Descriptor() ([]byte, []int) { return fileDescriptorConsensus, []int{4} }
...
func (*Signature) Descriptor() ([]byte, []int) { return fileDescriptorConsensus, []int{5} }
...
func (*Transaction) Descriptor() ([]byte, []int) { return fileDescriptorConsensus, []int{6} }
...
func (*AddDataTransaction) Descriptor() ([]byte, []int) { return fileDescriptorConsensus, []int{7} }
...
func (*UpdateOwnershipTransaction) Descriptor() ([]byte, []int) {
	return fileDescriptorConsensus, []int{8}
}
...
func (*MintCoinTransaction) Descriptor() ([]byte, []int) { return fileDescriptorConsensus, []int{9} }
...
func (*SendCoinTransaction) Descriptor() ([]byte, []int) { return fileDescriptorConsensus, []int{10} }
...
func (*ReceiveCoinTransaction) Descriptor() ([]byte, []int) { return fileDescriptorConsensus, []int{11} }
...
func (*BalanceTransaction) Descriptor() ([]byte, []int) { return fileDescriptorConsensus, []int{12} }
...
func (*ChainTip) Descriptor() ([]byte, []int) { return fileDescriptorConsensus, []int{13} }
...
func (*Chain) Descriptor() ([]byte, []int) { return fileDescriptorConsensus, []int{14} }
...
func (*Block) Descriptor() ([]byte, []int) { return fileDescriptorConsensus, []int{15} }
...
func (*SignableBlock) Descriptor() ([]byte, []int) { return fileDescriptorConsensus, []int{16} }
...
func (*PublicKey) Descriptor() ([]byte, []int) { return fileDescriptorConsensus, []int{17} }
...
func (*Authorization) Descriptor() ([]byte, []int) { return fileDescriptorConsensus, []int{18} }
...
func (*Authentication) Descriptor() ([]byte, []int) { return fileDescriptorConsensus, []int{19} }
...
func (m *ReceiveCoinTransaction) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SendTransaction != nil {
		...
		n5, err := m.SendTransaction.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *Block) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SignableBlock != nil {
		...
		n9, err := m.SignableBlock.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func NewPopulatedBalanceTransaction(r randyConsensus, easy bool) *BalanceTransaction {
	...
	v13 := r.Intn(10)
	this.Transactions = make([]string, v13)
	for i := 0; i < v13; i++ {
...
func NewPopulatedChainTip(r randyConsensus, easy bool) *ChainTip {
	...
	if r.Intn(10) != 0 {
		v15 := r.Intn(5)
		this.LastSignatures = make([]*Signature, v15)
		for i := 0; i < v15; i++ {
	...
	if r.Intn(10) == 0 {
		v16 := r.Intn(5)
		this.Authorizations = make([]*Authorization, v16)
		for i := 0; i < v16; i++ {
			this.Authorizations[i] = NewPopulatedAuthorization(r, easy)
		}
	}
	v17 := r.Intn(100)
	this.Agent = make([]byte, v17)
	for i := 0; i < v17; i++ {
		this.Agent[i] = byte(r.Intn(256))
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedChain(r randyConsensus, easy bool) *Chain {
	...
	if r.Intn(10) == 0 {
		v19 := r.Intn(5)
		this.Authorizations = make([]*Authorization, v19)
		for i := 0; i < v19; i++ {
			this.Authorizations[i] = NewPopulatedAuthorization(r, easy)
		}
	}
...
func NewPopulatedBlock(r randyConsensus, easy bool) *Block {
	...
	if r.Intn(10) != 0 {
		v20 := r.Intn(5)
		this.Signatures = make([]*Signature, v20)
		for i := 0; i < v20; i++ {
	...
	if r.Intn(10) != 0 {
		v21 := r.Intn(5)
		this.TransactionSignatures = make([]*Signature, v21)
		for i := 0; i < v21; i++ {
...
func NewPopulatedSignableBlock(r randyConsensus, easy bool) *SignableBlock {
	...
	this.Sequence = uint64(uint64(r.Uint32()))
	v22 := r.Intn(100)
	this.PreviousHash = make([]byte, v22)
	for i := 0; i < v22; i++ {
...
func NewPopulatedAuthentication(r randyConsensus, easy bool) *Authentication {
	...
	if r.Intn(10) != 0 {
		v26 := r.Intn(5)
		this.PublicKeys = make([]*PublicKey, v26)
		for i := 0; i < v26; i++ {
...
func randFieldConsensus(dAtA []byte, r randyConsensus, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateConsensus(dAtA, uint64(v28))
	case 1:
		dAtA = encodeVarintPopulateConsensus(dAtA, uint64(key))
...
var fileDescriptorConsensus = []byte{
	...
	,
}
